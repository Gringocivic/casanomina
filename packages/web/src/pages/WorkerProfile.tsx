...
export function WorkerProfile() {
  ...
  // Existing custom-role workers skip re-screening on edit.
  ...
  const existingCustomRole = roleIsCustom && !!form.role && screeningQ1 === null && screeningQ2 === null;
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                {roleIsCustom && !existingCustomRole && !screeningFailed && !screeningPassed && (
                ...
                {roleIsCustom && (existingCustomRole || screeningPassed) && (
                  <input
                    type="text"
