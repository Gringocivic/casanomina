 ...
 *
 * All roles listed here are unambiguously domestic under LFT Art. 331 in the
 * context of a private household employer. Custom roles entered via "Other"
 * are screened at onboarding with two questions to confirm domestic status.
 */
export const ROLES = [
  ...
  { value: "nanny",              en: "Nanny / Caregiver",     es: "Niera / Cuidadora" },
